  ...
  return (
    <WizardLayout>
      <div className="wizard-design">
        ...
        <div className="wizard-design-content">
      ...
      <style>{`
        .wizard-design-header {
          margin-bottom: 1.5rem;
        }

        .wizard-design-header h2 {
          font-size: 1.5rem;
          font-weight: 700;
