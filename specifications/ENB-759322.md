...
| FR-759204 | Approval Validation | Pipeline checks SAWai approval status | Implemented | High | Approved |
...
Checks SAWai approval requirements.
...
Feature: Prework Pipeline
  ...
  @TS-759203 @FR-759203
  Scenario: Apply SAWai rules
    Given SAWai enforcement rule is enabled
...
| TS-759203 | Apply SAWai rules | FR-759203 | High | Implemented | Pending |
